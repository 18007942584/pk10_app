...
#define OPTION_EGRET_PLUGIN_CONF "egret.runtime.pluginconfiguration"
#define OPTION_GAME_GLVIEW_TRANSPARENT "egret.runtime.glview"
#define OPTION_PUBLISH_ZIP "egret.runtime.publishZip"
...
@property (nonatomic) NetworkStatusListener* networkStatusListener;
...
- (void)setIgnoreVersion:(NSString *)fileURl;
- (void)setLoaderTimeout:(int) time;
- (void)setAudioPlayBackgroundEnable:(bool) enable;
