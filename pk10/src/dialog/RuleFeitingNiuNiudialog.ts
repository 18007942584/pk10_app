class RuleFeitingNiuNiudialog extends BaseDialog {
    ...
    public createGameScene() {
        ...
        if (this.tab_type == "rewardResult") {
            ...
            if(this.channelName=='shpk10'){
                //四海
                //this.gameRuleImage.source = "ft_niuniu_png";
                this.gameRuleButton.skinName = "resource/skins/dialog/RuleViewFtNiuniu.exml";
            }else{
                //通用
                //this.gameRuleImage.source = "ty_ft_niuniu_png";
                this.gameRuleButton.skinName = "resource/skins/dialog/RuleViewTyFtNiuniu.exml";
            }
