class RuleFeitingNineDialog extends BaseDialog {
    ...
    public createGameScene() {
        ...
        if (this.tab_type == "rewardResult") {
            ...
            //this.gameRuleImage.source = "ft_paijiu_png";
            if(this.Game_id==5)//欧洲飞艇牌九
            {
                this.gameRuleButton.skinName = "resource/skins/dialog/RuleViewFtPaijiuOu.exml";
            }else if(this.channelName=='shpk10'){
                //四海
                //this.gameRuleImage.source = "ft_paijiu_png";
                this.gameRuleButton.skinName = "resource/skins/dialog/RuleViewFtPaijiu.exml";
            }else if(this.channelName=='mfpk10'&&this.is_official==1){
                //明发vip场规则附加说明
                this.gameRuleButton.skinName = "resource/skins/dialog/RuleViewTyFtVipPaijiu.exml";
            }else{
                //通用
                //this.gameRuleImage.source = "ty_ft_paijiu_png";
                this.gameRuleButton.skinName = "resource/skins/dialog/RuleViewTyFtPaijiu.exml";
            }
