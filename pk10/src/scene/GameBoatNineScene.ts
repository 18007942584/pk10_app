...
class GameBoatNineScene extends BaseScene {

    private gameData: GameBoatNineData = new GameBoatNineData();
   ...
   //public concoludeImage: eui.Image;
    ...
    private showCancleBetTicket:number=0;//显示取消下注时的时间
    ...
    public constructor() {
        super();
        this.skinName = "resource/skins/scene/GameBoatNineSceneSkin.exml";
    ...
    private onRewardResultHandler(evt: egret.TouchEvent): void {
        ...
        Director.getInstance().showFeitingRuleNineDialog(this, "rewardResult", "nine", this.sound_on, this.gameId,this.roomInfo.is_official);
    }
    ...
    private onRuleHandler(evt: egret.TouchEvent): void {
        ...
        Director.getInstance().showFeitingRuleNineDialog(this, "gameRule", "nine", this.sound_on, this.gameId,this.roomInfo.is_official);
    }
        ...
        switch (this.processState) {
            ...
            case ProcessState.ProcessStateBeting://下注阶段
                {//下注阶段没有倒计时
                    ...
                    if(currentTicket-this.showCancleBetTicket >= 15||!this.showCancleBet){
                        //取消下注倒计时15s后消失
                        this.showCancleBet=0;
                        this.cancleBetGroup.visible=false;
                        this.sureBetGroup.visible=false;
