...
class GameLonghuScene extends BaseScene {

    private gameData: GameLonghuData = new GameLonghuData();
    ...
    //开奖号码:1号位
    private longhuNum10Image: eui.Image;
    private longhuNum11Image: eui.Image;
    private longhuNum12Image: eui.Image;
    private longhuNum13Image: eui.Image;
    private longhuNum14Image: eui.Image;
    private longhuNum15Image: eui.Image;
    private longhuNum16Image: eui.Image;
    private longhuNum17Image: eui.Image;
    private longhuNum18Image: eui.Image;
    private longhuNum19Image: eui.Image;
    ...
    private roomType = RoomType.RoomeTypeLonghu;
    ...
    public constructor() {
        super();
        this.skinName = "resource/skins/scene/GameLonghuSceneSkin.exml";
    ...
    public createGameScene() {
        ...
        //隐藏开奖结果显示
        this.resultShowGroup.visible = false;
        this.resultFirstCodeImage.visible = false;
        this.resultCompareImage.visible = false;
        this.resultFithCodeImage.visible = false;
        this.resultNameImage.visible = false;
        //隐藏取消下注和确定下注
    ...
    public initServerParam(client_id) {
        ...
        for (let i = 0; i < 3; i++) {
            let area = i + 1;
            let areaBet = this.gameData.area_summary[area];console.log("area "+area+" areaBet>>>>>>>>>>>>>>"+areaBet);
            if (areaBet > 0) {
                //区域下注
    ...
    private areaTouchHandler(evt: egret.TouchEvent): void {
        ...
        let tip = "下注" + selectedChip + "到区域" + area_name;
        //Toast.launch(tip);
        console.log(tip);
    ...
    private ronOneRunComplete(code_image_id: Number): void {
        ...
        /*if(this.processState == ProcessState.ProcessStateRun && usedTicket >= 28){
            //超过指定时间没给开奖结果就切换状态了,直接reset
        ...
        }else*/ if (this.processState == ProcessState.ProcessStateRun || usedTicket < 8)//如果状态是run，或者跑了少于10秒，都继续跑
        {
            switch (code_image_id) {
                case 1:
    ...
    private startRaceStepThreeEnd() {
        ...
        this.resultFirstCodeImage.source = "longhu_num_" + openCodeList[0] + "_png";
        this.resultFithCodeImage.source = "longhu_num_" + openCodeList[4] + "_png";
        //计算开奖结果：和、龙、虎
        if (Number(openCodeList[0]) - Number(openCodeList[4]) == 0) {
            this.resultCompareImage.source = "dengyu_png";
            this.resultNameImage.source = "he1_png";
        } else if (Number(openCodeList[0]) - Number(openCodeList[4]) > 0) {
            this.resultCompareImage.source = "dayu_png";
            this.resultNameImage.source = "long1_png";
        } else if (Number(openCodeList[0]) - Number(openCodeList[4]) < 0) {
            this.resultCompareImage.source = "xiaoyu_png";
            this.resultNameImage.source = "hu1_png";
        }
        delay += 1000;

        //显示开奖计算结果
        //this.resultShowGroup.x=120;
        //this.resultShowGroup.y=220;
        //this.resultShowGroup.width=400;
        //this.resultShowGroup.height=160;
        this.resultFirstCodeImage.x = 20;
        this.resultFirstCodeImage.y = 45;
        this.resultFirstCodeImage.width = 70;
        this.resultFirstCodeImage.height = 70;
        this.resultCompareImage.x = 108;
        this.resultCompareImage.y = 45;
        this.resultCompareImage.width = 70;
        this.resultCompareImage.height = 70;
        this.resultFithCodeImage.x = 195;
        this.resultFithCodeImage.y = 45;
        this.resultFithCodeImage.width = 70;
        this.resultFithCodeImage.height = 70;
        this.resultNameImage.x = 288;
        this.resultNameImage.y = 30;
        this.resultNameImage.width = 100;
        this.resultNameImage.height = 100;
        this.resultShowGroup.visible = true;
        this.resultFirstCodeImage.visible = true;
        this.resultFithCodeImage.visible = true;
        this.resultCompareImage.visible = true;
        this.resultNameImage.visible = true;
        //移动开奖结果显示
        var tw = egret.Tween.get(this.resultShowGroup);
        tw.to({ x: 120, y: 220, width: 480, height: 160 }, delay);
    ...
    //
    private onOutResultShowComplete(): void {
        // this.resultShowGroup.x=6;
        // this.resultShowGroup.y=60;
        // this.resultShowGroup.width=240;
        // this.resultShowGroup.height=80;
        this.resultFirstCodeImage.x = 24;
        this.resultFirstCodeImage.y = 20;
        this.resultFirstCodeImage.width = 35;
        this.resultFirstCodeImage.height = 35;
        this.resultCompareImage.x = 74;
        this.resultCompareImage.y = 20;
        this.resultCompareImage.width = 35;
        this.resultCompareImage.height = 35;
        this.resultFithCodeImage.x = 124;
        this.resultFithCodeImage.y = 20;
        this.resultFithCodeImage.width = 35;
        this.resultFithCodeImage.height = 35;
        this.resultNameImage.x = 176;
        this.resultNameImage.y = 10;
        this.resultNameImage.width = 50;
        this.resultNameImage.height = 50;
        this.resultShowGroup.visible = false;
        this.resultFirstCodeImage.visible = false;
        this.resultFithCodeImage.visible = false;
        this.resultCompareImage.visible = false;
    ...
    private restResultShowHandle(): void {
        //移除开奖计算结果显示
        let delay = 800;
        var tw = egret.Tween.get(this.resultShowGroup);
        tw.to({ x: 6, y: 60, width: 240, height: 80 }, delay).call(this.onOutResultShowComplete, this);
    }
    ...
    private showChipAnimation() {
        ...
        let that = this;
        if (this.settlementResult.resultInfoLonghu != null) {//系统庄家模式
            let delay = 0;
            let that = this;
            delay += 1000;
    ...
    private cancleBetHandler(){
        ...
        let chipCancleImageList1 = new Array();
                let chipCancleImageList2 = new Array();
                let chipCancleImageList3 = new Array();
                let areaSelfBet1:number=0;
                let areaSelfBet2:number=0;
                let areaSelfBet3:number=0;
                let totalSelfBet:number=0;
    ...
    private onRewardResultHandler(evt: egret.TouchEvent): void {
        ...
        Director.getInstance().showRuleLonghuDialog(this, "rewardResult", "longhu", this.sound_on, this.gameId,this.roomInfo.is_official);
    }
    ...
    private onRuleHandler(evt: egret.TouchEvent): void {
        ...
        Director.getInstance().showRuleLonghuDialog(this, "gameRule", "longhu", this.sound_on, this.gameId,this.roomInfo.is_official);
    }
    ...
    private concludeHandler(): void {
        ...
        //console.log("结算------------------------------------------------"+this.settlementResult.resultInfoLonghu);
        if (this.settlementResult.resultInfoLonghu != null) {
            resultUserList = this.settlementResult.resultInfoLonghu.users;
            bankerReward = 0;
        }
    ...
    private testHandler(evt: egret.TouchEvent): void {
        ...
        */
        ...
        tw.to({}, 0).call(function () {
            ...
            .call(function () {
                //玩家下注
                let msg_bet_1 = "{\"type\":\"bet\",\"msg\":\"\",\"area\":\"1\",\"number\":\"1000\",\"area_summary\":[{\"area\":1,\"number\":\"10\"}]}";
                let msg_bet_2 = "{\"type\":\"bet\",\"msg\":\"\",\"area\":\"2\",\"number\":\"500\",\"area_summary\":[{\"area\":2,\"number\":\"10\"}]}";
                SocketEngine.getInstance().test_send_message(msg_bet_1);
                SocketEngine.getInstance().test_send_message(msg_bet_2);
            }).to({}, 500)
            .call(function () {
                //玩家下注
                let msg_bet_3 = "{\"type\":\"bet\",\"msg\":\"\",\"area\":\"3\",\"number\":\"100\",\"area_summary\":[{\"area\":3,\"number\":\"10\"}]}";
