...
class GameNiuniuScene extends BaseScene {

    private gameData:GameNiuniuData = new GameNiuniuData();
   ...
   //public concoludeImage: eui.Image;
    ...
    private cancleBetImage:eui.Image;//取消下注背景图
    private sureBetTimeLabel:eui.Label;//取消下注倒计时，封盘前3s消失
    ...
    public constructor() {
        super();
        this.skinName = "resource/skins/scene/GameNiuniuSceneSkin.exml";
    ...
    private onRewardResultHandler(evt: egret.TouchEvent): void {
        ...
        Director.getInstance().showRuleNiuNiudialog(this,"rewardResult","nine",this.sound_on,this.gameId,this.roomInfo.is_official);
    }
    ...
    private onRuleHandler(evt: egret.TouchEvent): void {
        ...
        Director.getInstance().showRuleNiuNiudialog(this, "gameRule", "nine",this.sound_on,this.gameId,this.roomInfo.is_official);
    }
