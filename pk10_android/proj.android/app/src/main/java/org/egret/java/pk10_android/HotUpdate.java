...
public class HotUpdate {
    ...
    //public String jsonUrl = "http://pk.kn86.cn/update_shpk10/version.php";
    ...
    public HotUpdate(Context ctx, String gid) {
        ...
        try {
            ...
            String update_url = appInfo.metaData.getString("UPDATE_URL");
        ...
        if(jsonUrl.length()==0)
        {
            ...
            String update_url = "http://pk.kn86.cn/update_"+appName+"/version.php";
            jsonUrl = update_url;
        }
    }
    ...
    public void runGame(String updateUrl) {
        ((pk10_android)context).runGameAfterHotUpdate(updateUrl);
    }
    ...
    public class HotUpdateTask extends AsyncTask<Integer, Integer, String> {
        ...
        private String checkAppVersionUpdate(final Context context, String jsonInfo)
        {
            try
            {
                JSONObject jsonObject = new JSONObject(jsonInfo);
                final String app_update_url = jsonObject.getString("app_update_url");
                final String app_version_android = jsonObject.getString("app_version_android");

                String currentVersionName = getAppVersionName(context);
                int versionCheck = compareVersion(currentVersionName, app_version_android);
                if(versionCheck==-1)
                {
        ...
        protected String doInBackground(Integer... params) {
            ...
            String app_update_url = checkAppVersionUpdate(context, jsonInfo);
            if(app_update_url.length()>0)
            {
                return "update_apk="+app_update_url;
            }
        ...
        protected void onPostExecute(String result) {
            ...
            else if (result.startsWith("update_apk=")){
                final String app_update_url = result.replaceAll("update_apk=", "");

                new AlertDialog.Builder(context)
                        .setTitle("更新提示")
                        .setMessage("有新版本需要更新，点击确定更新")
